...
Роль `base.install_packages` предоставляет комплексные возможности установки пакетов для систем семейства Debian/Ubuntu с расширенными функциями, включая опциональные автоматические обновления безопасности, структурированное логирование и надежную обработку ошибок.
...
### С включенными автобновлениями безопасности

```yaml
---
- name: Установка пакетов с автобновлениями безопасности
  hosts: all
  become: yes
  roles:
    - role: base.install_packages
...
|---------------|------------------|---------------------------|
| Debian/Ubuntu | APT | unattended-upgrades (опционально) |

### Функции для Debian/Ubuntu
...
- Опциональные автоматические обновления безопасности
